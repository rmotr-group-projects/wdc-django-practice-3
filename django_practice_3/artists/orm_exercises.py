...
def task_5_songs_exclude():
    ...
    return Song.objects.exclude(title__contains='Castle')
...
def task_7_get_or_create_artist():
    ...
    artist, created = Artist.objects.get_or_create(artistic_name='Eric Clapton')
    return created
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(artistic_name='new artist')
