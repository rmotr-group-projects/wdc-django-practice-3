...
def task_1_artist_exists():
    ...
    clapton = Artist.objects.filter(artistic_name="Eric Clapton")
    return clapton.exists()
...
def task_8_artist_songs_reverse_relationship():
    ...
    artist = Artist.objects.get(artistic_name__icontains='wonder')
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(artistic_name='Kanye', popularity=5)
